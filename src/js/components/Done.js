...
var Done = React.createClass({
   returnFullDataObject: function() {
       
        var info = data.getData('info') || {};

      
        return {
            data.getData('nickName')
        };
    }, 
    ...
    return (
      <div>
        ...
        <button className="myButton" onClick={this.continueOrder} type="button" disabled={disabled}>LET THERE BE PIZZA</button>
